...
async def main():
    print("======================================================================")
    print("E2E MANUAL UPDATE TEST FOR CLOUD DEVICE: gl-db-011")
    print("======================================================================")
    ...
    # 2. Test UPDATE
    print("\n[+] 2. Executing update for gl-db-011...")
    update_result = await mcp_server._execute_agent_command(
        query="update gl-db-011",
        env="dev",
        agent_type="cloud",
        provider_or_protocol="mock_cloud",
        resource_type="database_service"
