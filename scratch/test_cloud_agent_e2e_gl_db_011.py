...
async def main():
    print("======================================================================")
    print("E2E MANUAL TEST FOR CLOUD DEVICE: gl-db-011")
    print("======================================================================")

    # 1. Check Status
    print("\n[+] 1. Fetching status of gl-db-011...")
    ...
    # 2. Test Power ON
    print("\n[+] 2. Executing power ON for gl-db-011...")
    power_on_result = await mcp_server._execute_agent_command(
        query="turn ON gl-db-011",
        env="dev",
        agent_type="cloud",
        provider_or_protocol="mock_cloud",
        resource_type="database_service"
    ...
    # 3. Check Status again to confirm power state is ON
