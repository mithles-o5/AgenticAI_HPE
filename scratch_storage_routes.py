...
def put_rest_{var}_id_batch2(id: str, payload: dict):
    \"\"\"
...
with open("d:/HPE CPP/MCP_Integrated/mock_server(oneview)/routes_storage_generated.py", "w") as f:
    f.write(out)

print("Generated routes_storage_generated.py")
